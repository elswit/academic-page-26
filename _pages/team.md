...
profiles:
  # Current Members
  - align: left
    image: people/ArashSarshar.jpg
    content: about_arash.md
    image_circular: false
    more_info: >
      <p><strong>Arash Sarshar</strong></p>
      <p>Director</p>
      <p>ECS 536</p>

  - align: right
    image: people/GabeLucero.jpg
    content: about_gabe.md
    image_circular: false
    more_info: >
      <p><strong>Gabriel Lucero</strong></p>
      <p>PhD Student</p>

  - align: left
    image: people/SakolBun.png
    content: about_sakol.md
    image_circular: false
    more_info: >
      <p><strong>Sakol Bun</strong></p>
      <p>MSc Student</p>

  # Former Members
  - align: right
    image: people/AmoghRaj.jpg
    content: about_amogh.md
    image_circular: false
    more_info: >
      <p><strong>Amogh Raj</strong></p>
      <p>MSc Student (Former)</p>

  - align: left
    image: people/CarolGudumotu.jpg
    content: about_carol.md
    image_circular: false
    more_info: >
      <p><strong>Carol Gudumotu</strong></p>
      <p>MSc Student (Former)</p>

  - align: right
    image: people/KeerthanaSrinivasa.jpg
    content: about_keerthana.md
    image_circular: false
    more_info: >
      <p><strong>Keerthana Srinivasa</strong></p>
      <p>MSc Student (Former)</p>
---
...
<div class="row mb-4">
  <div class="col-md-3">
    <img src="/assets/img/CSML-Logo-2024.png" alt="CSML Logo" class="img-fluid">
  </div>
  <div class="col-md-9">
    <p>The Computational Science and Machine Learning Lab (CSML) is an interdisciplinary research lab at Cal State Long Beach focusing on aiding scientific computation using algorithmic innovation and machine learning methodologies.</p>
    <p><strong>GitHub:</strong> <a href="https://github.com/csml-beach">https://github.com/csml-beach</a></p>
  </div>
</div>
